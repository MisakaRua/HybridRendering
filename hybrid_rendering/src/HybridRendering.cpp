...
namespace
{
	...
	class HybridRendering : public entry::AppI
	{
	public:
		HybridRendering(const char* _name, const char* _description, const char* _url)
		...
		HybridRendering(const HybridRendering&) = delete;
		HybridRendering& operator=(const HybridRendering&) = delete;
		~HybridRendering()
		{
...
{
	HybridRendering app("Hybrid Rendering"
		, "BGFX rendering a cube."
		, "https://github.com/MisakaRua/HybridRendering"
		);
