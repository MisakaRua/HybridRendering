...
public:
	...
	/// @param m_vertex_buffer address of the first vertex we want to update. Must be valid up to m_vertex_buffer + offset + 3*stride + 4*sizeof(int16_t), which means the buffer must contains at least 4 vertex includind the first.
